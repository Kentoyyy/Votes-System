...
// Fetch candidates running for Treasurer with their votes from the database
$sql = "SELECT candidates.id, candidates.name, candidates.position, 
        ...
        WHERE candidates.position = 'Treasurer'
...
<body>
    ...
    <div class="right-container">
        <h2>Treasurer, Race!</h2>
        <div class="line"></div>
        <p>Here’s the candidates for running in Treasurer position!</p>
    ...
    <button class="view-button" onclick="window.location.href='Dashboard_VotingVC.php'">View Vice Presidency</button>
